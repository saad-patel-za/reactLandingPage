  ...
  <section id="product" className={layout.sectionReverse}>
    ...
    <div className={layout.sectionInfo}>
      ...
      <div className="flex flex-wrap flex-row sm:mt-10 mt-6">
        <img src={google} alt="google_play" className="w-[128px] h-[42px] mr-5 object-contain cursor-pointer"/>
        <img src={apple} alt="apple_play" className="w-[128px] h-[42px]  object-contain cursor-pointer"/>
      </div>
    </div>
  </section>
)
